# ruff: noqa: E501
"""Source template for emitted scripts.

The value is deliberately a string: it is not imported or executed by the
ModelPact package.  Keep the generated program dependent only on Python,
PyTorch, SafeTensors, and (for YAML contracts) PyYAML.
"""

STANDALONE_TEMPLATE = r'''#!/usr/bin/env python3
